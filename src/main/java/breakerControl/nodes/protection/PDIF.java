...
public class PDIF extends LN {
    ...
    public void process() {
        for (HWYE w:inputHarm){
            if(!BlockA.getValue()){
                BlockA.setValue(w.getPhsAHar().get(5).getMag().getF().getValue()/w.getPhsAHar().get(1).getMag().getF().getValue()
            ...
            if(!BlockB.getValue()){
                BlockB.setValue(w.getPhsBHar().get(5).getMag().getF().getValue()/w.getPhsBHar().get(1).getMag().getF().getValue()
                        > StrHarm.getSetMag().getF().getValue());
            }
            else{
            ...
            if(!BlockC.getValue()){
                BlockC.setValue(w.getPhsCHar().get(5).getMag().getF().getValue()/w.getPhsCHar().get(1).getMag().getF().getValue()
                        > StrHarm.getSetMag().getF().getValue());
            }
            else{
